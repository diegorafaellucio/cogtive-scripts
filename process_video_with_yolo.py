...
def process_video(model_path, video_path, output_path=None, conf_threshold=0.1, 
                  iou_threshold=0.45, show_preview=False, resize_factor=1.0):
    """
    ...
    Args:
        ...
        resize_factor (float, optional): Factor to resize input frames before processing. Default is 1.0.
...
def main():
    ...
    parser.add_argument("-r", "--resize", type=float, default=1.0,
                        help="Resize factor for input frames (default: 1.0)")
